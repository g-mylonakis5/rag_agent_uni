...
def is_code_safe(code_string):
    """
    Security Defense Layer: Validates LLM-generated Python code using Abstract Syntax Tree (AST) 
    to prevent Remote Code Execution (RCE) and Local File Inclusion (LFI).
    """
